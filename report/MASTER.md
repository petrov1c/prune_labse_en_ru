...
По технике квантования существует, к примеру, эта [статья](https://arxiv.org/pdf/1602.02830), в рамках которой было выполнено обучение бинарных нейросетей на основе MNIST, CIFAR-10 и SVHN с получением уменьшения потребления вплоть до 32 раз (float переведён bool) и ускорения вычислений вплоть до 7 раз (за счёт оптимизации вычислений на бинарных данных).
