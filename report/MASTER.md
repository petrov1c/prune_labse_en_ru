...
Текущий результат был получен в ограничениях как по вычислительным ресурсам (RTX 3090), так и по времени (несколько суток проведения экспериментов). Однако он вполне сопоставим с результатами известных работ, описанных [пункте 3](#Related).
