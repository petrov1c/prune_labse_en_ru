...
Более подробно про данный метод и результаты можно прочитать в статье авторов: https://arxiv.org/pdf/1910.01108

По технике квантования существует, к примеру, эта [статья](https://arxiv.org/pdf/1602.02830), в рамках которой было выполнено обучение бинарных нейросетей на основе MNIST, CIFAR-10 и SVHN с получением уменьшения потребления вплоть до 32 раз (float переведён в bool) и ускорения вычислений вплоть до 7 раз (за счёт оптимизации вычислений на бинарных параметрах).
Более подробно про данный метод и результаты можно прочитать в статье авторов: https://arxiv.org/pdf/1602.02830
