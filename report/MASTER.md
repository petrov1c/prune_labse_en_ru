...
В рамках проекта поставлена цель достичь уменьшения размера модели архитектуры Bert до без значительного ухудшения качества выдаваемого результата, то есть, получить в результате более быструю и компактную сеть без заметной потери в качестве.
